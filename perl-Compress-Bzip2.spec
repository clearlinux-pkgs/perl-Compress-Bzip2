...
Version  : 2.27
Release  : 17
URL      : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/Compress-Bzip2-2.27.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/Compress-Bzip2-2.27.tar.gz
...
%prep
%setup -q -n Compress-Bzip2-2.27
cd %{_builddir}/Compress-Bzip2-2.27
...
cp %{_builddir}/Compress-Bzip2-2.27/COPYING %{buildroot}/usr/share/package-licenses/perl-Compress-Bzip2/ff8688f52f05aa77ac2522c7970e6ab23bf77d0e
cp %{_builddir}/Compress-Bzip2-2.27/bzlib-src/LICENSE %{buildroot}/usr/share/package-licenses/perl-Compress-Bzip2/1c0c6888759a63c32bca7eb63353af2cd9bd5d9e
if test -f Makefile.PL; then
