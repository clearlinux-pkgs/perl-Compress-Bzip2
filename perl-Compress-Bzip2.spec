...
cd %{_builddir}/Compress-Bzip2-2.26
...
cp %{_builddir}/Compress-Bzip2-2.26/COPYING %{buildroot}/usr/share/package-licenses/perl-Compress-Bzip2/ff8688f52f05aa77ac2522c7970e6ab23bf77d0e
cp %{_builddir}/Compress-Bzip2-2.26/bzlib-src/LICENSE %{buildroot}/usr/share/package-licenses/perl-Compress-Bzip2/1c0c6888759a63c32bca7eb63353af2cd9bd5d9e
if test -f Makefile.PL; then
